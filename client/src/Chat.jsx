      ...
      <div className="flex flex-col bg-white w-1/3 xl:w-1/4 border-r border-gray-100">
        <div className="flex-grow overflow-y-scroll thin-scroll">
          <div className="flex justify-between items-center">
            <Logo />
            <div className="flex gap-1 items-center text-blue-600 font-semibold mx-2 text-lg bg-gray-100 p-2 rounded-full">
              <svg
              ...
              <div className={"w-fit md:block hidden"}>{userName}</div>
            </div>
          </div>
